...
set_property PACKAGE_PIN J1 [get_ports firstswitch]
set_property IOSTANDARD LVCMOS33 [get_ports firstswitch]
set_property PACKAGE_PIN L2 [get_ports secondswitch]
set_property IOSTANDARD LVCMOS33 [get_ports secondswitch]
